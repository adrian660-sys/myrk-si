...
export default function AboutSection() {
  ...
  return (
    <section
      ...
      data-section
      ref={sectionRef}
      className="bg-white py-20 md:py-32 px-6 md:px-14 overflow-hidden"
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 mb-16">
          ...
          {/* LEFT: label + headline + divider + origin quote */}
          <div className="anim flex flex-col gap-6">
            <p className="font-sans text-xs tracking-[0.35em] uppercase text-[#c9a84c]">
              About
            </p>
            <h2 className="font-serif text-[clamp(2.6rem,5.5vw,5rem)] font-light leading-[1.05] text-[#1a1a1a]">
              Built from<br />a dark place.
            </h2>
            <div className="w-12 h-px bg-[#1a1a1a]/15" />
            <p className="font-serif text-lg italic font-light text-[#1a1a1a]/50 leading-relaxed max-w-xs">
              "I run myrk. because I choose who I work with."
            </p>
          </div>

          {/* RIGHT: three paragraphs + gold quote */}
          <div className="anim flex flex-col gap-5 justify-center">
            ...
            <p className="font-serif text-[1.15rem] italic font-light text-[#c9a84c] mt-2 leading-snug">
        ...
        <div className="anim">
          <div
            className="w-full max-w-[400px] flex flex-col items-center justify-center gap-3"
            style={{
              height: "500px",
              background: "#111111",
